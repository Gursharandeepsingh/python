...
class form1:
    def add(self):
        if self.tb1.get()=="" or self.tb2.get()=="" :
            ...
            obj=open("d:\\py_project\\message_project1.txt","a")
            gpname=self.tb1.get()
...
class form2:
    def __init__(self):
        ...
        self.rd=open("d:\\py_project\\message_project1.txt","r")
        self.i=0
        while True:
...
class form3:
    def insert(self):
        if self.textbox2.get()!="" and self.textbox2.get().isnumeric()==True and len(self.textbox2.get())==10:
            ...
            wr=open("d:\\py_project\\phones.txt","a")
            gpname=self.cb1.get()
            name=self.textbox1.get()
            number=self.textbox2.get()
            wr.write(gpname)
            wr.write(name)
            wr.write("\n")
            wr.write(number)
        ...
        elif self.textbox1.get()=="" or self.textbox2.get()=="":
            tkinter.messagebox.showinfo("","All Fields Are Mandatory")
        else:
    ...
    def __init__(self):
        ...
        fileopen=open("d:\\py_project\\message_project1.txt","r")
...
class form4:
    ...
    def insert(self):
        ...
        rd=open("d:\\py_project\\phones.txt","r")
        i=0
        while True:
            line=rd.readline()
            if line=="":
    ...
    def covertmob(self):
        ...
        for child in self.tree.get_children():
            ...
            conn.request('GET',"/VMMCloudMessaging/AWS_SMS_Sender?username=amrinder&password=hello789&message="+a+"&phone_numbers="+num+"")
...
label1.pack()
root.config(bg="bisque")
label2=tkinter.Label(root,text=" By:-MANISHA MAINI ",bg="mint cream",fg="black",font="HELVETICA 14")
label2.pack()
